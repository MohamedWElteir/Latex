...
\section{Professional Training}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Participated in a 6-month intensive training program focusing on competitive programming and problem-solving.}
        \resumeItem{Enhanced problem-solving skills and learned advanced algorithms and data structures.}
        \resumeItem{Developed a strong foundation in competitive programming and problem-solving techniques.}
      \resumeItemListEnd
      ...
      \resumeSubheading
        ...
        \resumeItemListStart
          \resumeItem{Participated in a 6-week training program focusing on open-source development and software engineering.}
