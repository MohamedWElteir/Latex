...
\section{Projects}
  ...
  \resumeProjectHeading
    ...
    \resumeItemListStart
      ...
      \resumeItem{API uses Output Caching with different configurations, depending on which CORS policy used to match any business needs and improve performance by reducing the load on the database.}
    \resumeItemListEnd
    \vspace{-13pt}
      \resumeProjectHeading
