...
\resumeItemListStart
\resumeItem{Created a console-based Turing Machine simulator for a Theory of Computation course, accurately emulating the behavior of a real Turing Machine. the simulator's performance was optimized by 30\% by using more efficient algorithms.}
\resumeItemListEnd
    \resumeSubHeadingListEnd
\vspace{-15pt}
