...
\section{Projects}
    ...
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{Social Media API} $|$ \emph{.NET}}{August 2024}
          \resumeItemListStart
        \resumeItem{Developed a comprehensive social media API featuring full user authentication and authorization using JWT and bearer tokens, ensuring secure access to user data.}
        \resumeItem{Implemented DynamicParameters to efficiently handle SQL queries, enhancing the flexibility and performance of database operations.}
        \resumeItem{Followed APIs best practices, including versioning, pagination, and filtering, to ensure a consistent and user-friendly experience.}
        \resumeItem{Followed most of the \textbf{SOLID} principles, including \textbf{Single Responsibility}, \textbf{Open/Closed}, and \textbf{Dependency Inversion}, to ensure maintainable and scalable code.}
        \resumeItem{Utilized xUnit.NET to create unit tests for the API, achieving 90\% code coverage.}
          \resumeItemListEnd
          \vspace{-13pt}
      \resumeProjectHeading
