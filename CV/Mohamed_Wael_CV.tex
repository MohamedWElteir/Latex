...
\resumeItemListStart
\resumeItem{Created a console-based Turing Machine simulator for a Theory of Computation course, accurately emulating the behavior of a real Turing Machine. Written in C++, the simulator's performance was optimized by 30\% through the use of efficient algorithms.}
\resumeItemListEnd
    \resumeSubHeadingListEnd
\vspace{-15pt}
...
\section{Volunteer Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {HackerRank Campus Club, AUFS}{January 2024 -- October 2024}
